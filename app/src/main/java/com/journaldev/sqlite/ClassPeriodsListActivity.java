...
public class ClassPeriodsListActivity extends AppCompatActivity {
    ...
    final String[] from = new String[] { DatabaseClassPeriodsHelper._ID,
            DatabaseClassPeriodsHelper.PERIODSNAME };

    final int[] to = new int[] { R.id.id, R.id.ClassPeriods_name_textview };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_classperiods_list);
...
//                Toast.LENGTH_SHORT).show();
        ...
        adapter = new SimpleCursorAdapter(this, R.layout.classperiods_view_record, cursor, from, to, 0);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long viewId) {
                ...
                TextView studentidTextView = (TextView) view.findViewById(R.id.ClassPeriods_name_textview);

                String id = idTextView.getText().toString();
                String studentid = studentidTextView.getText().toString();

                Intent modify_intent = new Intent(getApplicationContext(), ModifyClassPeriodsActivity.class);
...
*/
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.add_record) {
            ...
            Intent add_mem = new Intent(this, AddClassPeriodsActivity.class);
