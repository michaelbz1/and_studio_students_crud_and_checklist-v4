...
public class ConsequenceListActivity extends AppCompatActivity {
    ...
    final String[] from = new String[] { DatabaseConsequenceHelper._ID,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_consequence_list);
...
//                Toast.LENGTH_SHORT).show();
        ...
        adapter = new SimpleCursorAdapter(this, R.layout.consequence_view_record, cursor, from, to, 0);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long viewId) {
                ...
                Intent modify_intent = new Intent(getApplicationContext(), ModifyConsequenceActivity.class);
...
*/
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.add_record) {
            ...
            Intent add_mem = new Intent(this, AddConsequenceActivity.class);
